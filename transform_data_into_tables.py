...
def transform(df, *args, **kwargs):
    ...
    return {'datetime_dim':datetime_dim.to_dict(),
            'fact_table':fact_table.to_dict(),
            'payment_type_dim':payment_type_dim.to_dict(),
            'rate_code_dim':rate_code_dim.to_dict(),
            'pickup_location_dim':pickup_location_dim.to_dict(),
            'dropoff_location_dim':dropoff_location_dim.to_dict()}
